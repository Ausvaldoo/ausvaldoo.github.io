...
> ⚠️ **「权力与制度」已占 16/39 ≈ 41%，偏胖了。** 2026-09-12 同步《从琴弓到电塔》三部曲
> 与《断裂与闭环》后涨上来的。下次再进同题材文章时，优先考虑**是否该把它拆开**
> （比如把「政治经济学」单独成类：劳动、分配、食利、福利这条线目前散在里面）。
...
| 覆盖较广 | | | | | |
|---|---|---|---|---|---|
| 知乎(33) | 权力(14) | 制度(14) | 历史(9) | 言论空间(8) | 社会心理(7) |
| 方法论(7) | 意识形态(7) | 信息管控(6) | 法治与宪法(5) | 政治思想史(5) | 劳动与经济(5) |
| 伦理(5) | 阶层与身份(3) | 文艺(2) | 性别(2) | 历史记忆(2) | 人工智能(2) |
| **只覆盖 1 篇（专有主题，保留）** | | | | | |
