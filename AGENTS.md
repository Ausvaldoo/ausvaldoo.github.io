...
| 覆盖较广 | | | | | |
|---|---|---|---|---|---|
| 知乎(57) | 权力(26) | 制度(26) | 意识形态(17) | 历史(16) | 社会心理(13) |
| 劳动与经济(12) | 方法论(11) | 政治思想史(10) | 信息管控(9) | 言论空间(8) | 阶层与身份(7) |
| 法治与宪法(7) | 伦理(6) | 历史记忆(4) | 文艺(3) | 性别(2) | 婚姻(2) |
| **覆盖较少（1~2 篇，专有主题，保留）** | | | | | |
| 投资(2) | 人工智能(2) | 语言与文字(1) | 福利与养老(1) | 工业自动化(1) | PLC(1) |

> 篇数为 2026-09-19 统计（**59 篇**，字符串计数）。**「知乎」是来源标记，从知乎同步的每篇都要有** ——
> 59 篇里 57 篇有，剩 2 篇是站内原创（PE 分位、QP 移植）。
> ⚠️ 注意「政治思想史」**既是标签（10 篇）又是分类（4 篇）** —— 这是允许的，两者职责不同
